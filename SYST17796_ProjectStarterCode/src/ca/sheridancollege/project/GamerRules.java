...
public class GamerRules
{
    ...
    public static void runGame(Scanner inputs)
    {
        ...
        MyBot bot; // when bot want to play
        ...
        while (!endGame())
        {
            ...
            if (!(currentPlayer instanceof MyBot))
            {
                while (true)
                {
                    // ask the player password
                    MyPrinter.getPassToStartTurn(currentPlayer);
            ...
            if (!checkPlayerCards(currentPlayer))
            {
                ...
                if (!checkPlayerCards(currentPlayer))
                {
                    ...
                    MyPrinter.printGameBoard(boardCard, boardColor);
                    MyPrinter.printNumberOfPlayersCards(players, currentPlayerindex );
                    MyPrinter.printPlayerCards(currentPlayer);


                    // say to player that he/she can't choose any card
                    if (!(currentPlayer instanceof MyBot))
                        MyPrinter.noChoiceError(inputs);
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    MyPrinter.getPlayerChoice(currentPlayer);
                    holdInput = inputs.nextLine();
                ...
                if (checkChoose(playerChoosenCard, currentPlayer))
                {
                    if (playerChoosenCard instanceof WildCard || playerChoosenCard instanceof WildDrawCard)
                    {
                        ...
                        while (true)
                        {
                            ...
                            MyPrinter.getPlayerChoosenColor();
                            holdInput = inputs.nextLine();
        ...
        sortPlayers();
        MyPrinter.printScores(players, inputs);
    }
